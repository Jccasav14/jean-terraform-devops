...
resource "aws_key_pair" "key_pair" {
  key_name   = "${var.environment}-key" # Nombre dinámico: ej: dev-key
...
resource "local_file" "private_key" {
  ...
  file_permission = "0400" # Permisos seguros para SSH
}

# ----------------------------------------------------
# Data source para obtener la plantilla de User Data (EXISTENTE)
# ----------------------------------------------------
...
  key_name      = aws_key_pair.key_pair.key_name # <--- ¡CORREGIDO! Usa la llave creada
